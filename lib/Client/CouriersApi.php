...
class CouriersApi
{
     ...
     * @return \VoloCommerce\Api\v1\Model\CourierResponse
     */
    public function getCourierNames()
    {
        list($response) = $this->getCourierNamesWithHttpInfo();
        return $response;
    }
     ...
     *
     * @throws \VoloCommerce\Api\v1\ApiException on non-2xx response
     * @return array of \VoloCommerce\Api\v1\Model\CourierResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCourierNamesWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\VoloCommerce\Api\v1\Model\CourierResponse',
                '/couriers'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\VoloCommerce\Api\v1\Model\CourierResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\VoloCommerce\Api\v1\Model\CourierResponse', $e->getResponseHeaders());
