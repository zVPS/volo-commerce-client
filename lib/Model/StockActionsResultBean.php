...
/**
 * StockActionsResultBean Class Doc Comment
 *
 * @category    Class
 * @package     \VoloCommerce\Api\v1
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class StockActionsResultBean implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StockActionsResultBean';
    ...
    protected static $swaggerTypes = [
        'stock_actions' => '\VoloCommerce\Api\v1\Model\StockActionBean[]',
    ...
    {
        $this->container['stock_actions'] = isset($data['stock_actions']) ? $data['stock_actions'] : null;
    ...
    /**
     * Gets stock_actions
     * @return \VoloCommerce\Api\v1\Model\StockActionBean[]
     */
    public function getStockActions()
    {
        return $this->container['stock_actions'];
    }

    /**
     * Sets stock_actions
     * @param \VoloCommerce\Api\v1\Model\StockActionBean[] $stock_actions
     * @return $this
     */
    public function setStockActions($stock_actions)
    {
        $this->container['stock_actions'] = $stock_actions;
