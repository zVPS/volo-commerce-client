...
/**
 * UpdateSalesOrderAsyncBean Class Doc Comment
 *
 * @category    Class
 * @package     \VoloCommerce\Api\v1
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpdateSalesOrderAsyncBean implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateSalesOrderAsyncBean';
    ...
    protected static $swaggerTypes = [
        'order_update' => '\VoloCommerce\Api\v1\Model\OrderUpdateAsync[]'
    ];
    ...
    {
        $this->container['order_update'] = isset($data['order_update']) ? $data['order_update'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['order_update'] === null) {
            $invalid_properties[] = "'order_update' can't be null";
        }
    ...
    /**
     * Gets order_update
     * @return \VoloCommerce\Api\v1\Model\OrderUpdateAsync[]
     */
    ...
    /**
     * Sets order_update
     * @param \VoloCommerce\Api\v1\Model\OrderUpdateAsync[] $order_update
     * @return $this
     */
